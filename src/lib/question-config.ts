...
export type QuestionConfig = {
  field_key:string; position:number; label_am:string; label_en:string; input_type:InputType;
  required:boolean; amharic_only:boolean; min_words:number|null; max_words:number|null; exact_words:number|null;
...
const ETHIOPIC_WORD=/^[\u1200-\u137F]+$/,LATIN_WORD=/^[A-Za-z][A-Za-z'’.-]*$/;
